    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://ziad-0s.sentry.io/issues/?project=4509252149116928">Issues Page</a>.
